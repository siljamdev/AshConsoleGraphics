    ...
    public static class FastConsole
{
	...
	public class AshConsoleGraphics
    {
        ...
        public class GuiScreen
        {
            ...
            public void preparePrint()
            {
                ...
                for (int i = 0; i < this.elements.Count; i++)
                {
					...
					if (e.getX() < 0 || e.getY() < 0 || e.getX() > this.length || e.getY() > this.height){
						throw new Exception("Position of the element out of the screen");
					}
		...
		public class GuiFrame : GuiElement
        {
            ...
            public GuiFrame(char t,int X, int Y, int Xsize, int Ysize,Color C)
            {
                this.X = X;
                this.Y = Y;
                this.Xsize = Xsize;
        ...
        public class GuiSelectable : GuiElement
        {
            protected int index;
