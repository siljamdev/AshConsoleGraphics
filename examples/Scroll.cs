...
class Program{
	static void Main(){
		...
		TuiLabel fixd = new TuiLabel("Fixed label", Placement.Center, 0, 1);
		
		TuiScrollingScreenInteractive screen = new TuiScrollingScreenInteractive(100, 20, temp, 0, 0, null, new TuiLabel("Hello", Placement.Center, 0, 0), fixd);
		
		//Add the fixed label to the fixed elements list
		screen.FixedElements.Add(fixd);
